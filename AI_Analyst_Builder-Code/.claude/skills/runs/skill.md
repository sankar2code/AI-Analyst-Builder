...
|---|------------|-----------|--------------------------|-----------|--------|
| 1 | 2026-02-23 | my-analytics | why-revenue-dropped-q3   | completed | 14/14  |
| 2 | 2026-02-21 | my-analytics | activation-funnel-deep   | failed    | 8/14   |
...
`/runs my-analytics` matches the most recent my-analytics run). Display:
