#!/usr/bin/env python3
"""Main orchestrator for SampleMart dataset generation.
...
def main():
    ...
    practice_db = os.path.join(practice_dir, "practice_ecommerce_practice.duckdb")
    ...
    capstone_db = os.path.join(capstone_dir, "practice_ecommerce_capstone.duckdb")
